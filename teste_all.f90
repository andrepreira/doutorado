...
!  IMPLICIT none 
  ...
  DOUBLE PRECISION:: PAR, max = 0.0d0, segundo_max=0.0d0
  ...
  JOBZ="V"
   UPLO="U"
! gfortran teste_all.f90 -O2 -o teste.exe -L/usr/local/lib -llapack -lblas
tamanho_matriz = 3000
...
Do  seed1 =1, n_amostras
    ...
    !################### Calculo da função de onda máxima ao quadrado ######################!
      ...
      do j=1,contE
            ...
            WRITE(80,*)Ep(j),1.0d0/PAR,max, segundo_max
